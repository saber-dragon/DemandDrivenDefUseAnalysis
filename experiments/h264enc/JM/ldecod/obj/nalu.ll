...
@__PRETTY_FUNCTION__.NALUtoRBSP = private unnamed_addr constant [25 x i8] c"int NALUtoRBSP(NALU_t *)\00", align 1
...
define i32 @NALUtoRBSP(%struct.NALU_t* %nalu) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq %struct.NALU_t* %nalu, null
  br i1 %cmp, label %cond.false, label %cond.end

cond.false:                                       ; preds = %entry
  tail call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 38, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__PRETTY_FUNCTION__.NALUtoRBSP, i64 0, i64 0)) #3
  unreachable

cond.end:                                         ; preds = %entry
  %buf = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %nalu, i64 0, i32 6
  %0 = load i8*, i8** %buf, align 8, !tbaa !1
  %len = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %nalu, i64 0, i32 1
  %1 = load i32, i32* %len, align 4, !tbaa !7
  %call = tail call i32 @EBSPtoRBSP(i8* %0, i32 %1, i32 1) #4
  store i32 %call, i32* %len, align 4, !tbaa !7
  ret i32 %call
}
...
declare i32 @EBSPtoRBSP(i8*, i32, i32) local_unnamed_addr #2
