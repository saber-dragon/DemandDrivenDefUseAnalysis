...
define i32 @rd_pic_decision(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture) local_unnamed_addr #0 {
entry:
...
define i32 @picture_coding_decision(%struct.Picture* nocapture readonly %picture1, %struct.Picture* nocapture readonly %picture2, i32 %qp) local_unnamed_addr #1 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %type = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %2, i64 0, i32 6
  %3 = load i32, i32* %type, align 8, !tbaa !9
  %4 = or i32 %3, 2
  %5 = icmp eq i32 %4, 3
  %conv7 = select i1 %5, double 2.000000e+00, double 1.000000e+00
  %mul8 = fmul double %mul, %conv7
  br label %if.end

if.end:                                           ; preds = %entry, %if.then
  %lambda_picture.0 = phi double [ %mul8, %if.then ], [ %mul, %entry ]
  %distortion_y = getelementptr inbounds %struct.Picture, %struct.Picture* %picture1, i64 0, i32 4
  %6 = load float, float* %distortion_y, align 4, !tbaa !13
  %distortion_u = getelementptr inbounds %struct.Picture, %struct.Picture* %picture1, i64 0, i32 5
  %7 = load float, float* %distortion_u, align 8, !tbaa !15
  %add = fadd float %6, %7
  %distortion_v = getelementptr inbounds %struct.Picture, %struct.Picture* %picture1, i64 0, i32 6
  %8 = load float, float* %distortion_v, align 4, !tbaa !16
  %add14 = fadd float %add, %8
  %conv15 = fpext float %add14 to double
  %distortion_y16 = getelementptr inbounds %struct.Picture, %struct.Picture* %picture2, i64 0, i32 4
  %9 = load float, float* %distortion_y16, align 4, !tbaa !13
  %distortion_u17 = getelementptr inbounds %struct.Picture, %struct.Picture* %picture2, i64 0, i32 5
  %10 = load float, float* %distortion_u17, align 8, !tbaa !15
  %add18 = fadd float %9, %10
  %distortion_v19 = getelementptr inbounds %struct.Picture, %struct.Picture* %picture2, i64 0, i32 6
  %11 = load float, float* %distortion_v19, align 4, !tbaa !16
  %add20 = fadd float %add18, %11
  %conv21 = fpext float %add20 to double
  %bits_per_picture = getelementptr inbounds %struct.Picture, %struct.Picture* %picture2, i64 0, i32 3
  %12 = load i32, i32* %bits_per_picture, align 8, !tbaa !17
  %bits_per_picture22 = getelementptr inbounds %struct.Picture, %struct.Picture* %picture1, i64 0, i32 3
  %13 = load i32, i32* %bits_per_picture22, align 8, !tbaa !17
  %conv.i = sitofp i32 %13 to double
  %mul.i = fmul double %lambda_picture.0, %conv.i
  %add.i = fadd double %conv15, %mul.i
  %conv1.i = sitofp i32 %12 to double
...
rd_pic_decision.exit:                             ; preds = %if.end, %lor.lhs.false.i
  %call2337 = phi i32 [ %..i, %lor.lhs.false.i ], [ 0, %if.end ]
  ret i32 %call2337
}
...
!12 = !{!"short", !3, i64 0}
!13 = !{!14, !11, i64 812}
!14 = !{!"", !7, i64 0, !7, i64 4, !3, i64 8, !7, i64 808, !11, i64 812, !11, i64 816, !11, i64 820}
!15 = !{!14, !11, i64 816}
!16 = !{!14, !11, i64 820}
!17 = !{!14, !7, i64 808}
