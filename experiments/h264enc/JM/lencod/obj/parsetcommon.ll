...
@.str.3 = private unnamed_addr constant [19 x i8] c"src/parsetcommon.c\00", align 1
...
entry:
  %call = tail call noalias i8* @calloc(i64 240, i64 1) #4
  %0 = bitcast i8* %call to %struct.pic_parameter_set_rbsp_t*
  %cmp = icmp eq i8* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0)) #4
  br label %if.end
...
entry:
  %call = tail call noalias i8* @calloc(i64 2132, i64 1) #4
  %0 = bitcast i8* %call to %struct.seq_parameter_set_rbsp_t*
  %cmp = icmp eq i8* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %if.end
...
cond.false:                                       ; preds = %entry
  tail call void @__assert_fail(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i32 76, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.FreePPS, i64 0, i64 0)) #5
  unreachable
...
cond.end:                                         ; preds = %entry
  ...
  %0 = load i8*, i8** %slice_group_id, align 8, !tbaa !1
...
cond.false:                                       ; preds = %entry
  tail call void @__assert_fail(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i32 98, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.FreeSPS, i64 0, i64 0)) #5
  unreachable
...
!1 = !{!2, !6, i64 176}
!2 = !{!"", !3, i64 0, !5, i64 4, !5, i64 8, !3, i64 12, !3, i64 16, !3, i64 20, !3, i64 24, !3, i64 56, !5, i64 60, !5, i64 64, !3, i64 68, !3, i64 100, !3, i64 132, !3, i64 164, !5, i64 168, !5, i64 172, !6, i64 176, !5, i64 184, !5, i64 188, !3, i64 192, !5, i64 196, !5, i64 200, !5, i64 204, !5, i64 208, !5, i64 212, !5, i64 216, !3, i64 220, !3, i64 224, !3, i64 228, !3, i64 232}
